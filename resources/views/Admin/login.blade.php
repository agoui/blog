...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form">
            ...
            <div class="form-group">
                <input type="code" id="code" class="form-control" placeholder="二维码" required="">
...
<!-- 全局js -->
<script src="{{asset('/index/js/jquery.min.js?v=2.1.4')}}"></script>
<script src="{{asset('/index/js/bootstrap.min.js?v=3.3.6')}}"></script>
